            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="#product1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/shampoo.jpg" class="img-responsive" alt="샴푸">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/conditioner.jpg" class="img-responsive" alt="린스">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/bodywash.jpg" class="img-responsive" alt="바디워시">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/bodylotion.jpg" class="img-responsive" alt="바디로션">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>샴푸</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 791001");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/shampoo.jpg" class="img-responsive img-centered" alt="샴푸">
                            <p>상품설명</p>
                            ...
                            <input type="hidden" name=791001>
 				<button id="cartBtn" href="#none class="ctypebtn" onClick="product_submit(2, 'cart', this"> 장바구니에 추가</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>린스</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 791002");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/conditioner.jpg" class="img-responsive img-centered" alt="린스">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>바디워시</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 791003");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/bodywash.jpg" class="img-responsive img-centered" alt="샴푸">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>바디로션</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 791004");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/shampoo.jpg" class="img-responsive img-centered" alt="바디로션">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
