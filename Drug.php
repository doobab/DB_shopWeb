            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="#product1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/plaster.jpg" class="img-responsive" alt="파스">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/madecassol.jpg" class="img-responsive" alt="마데카솔">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/bandage.PNG" class="img-responsive" alt="밴드">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/tylenol.jpg" class="img-responsive" alt="타이레놀">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/mask.jpg" class="img-responsive" alt="마스크">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>파스</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 826001");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/plaster.jpg" class="img-responsive img-centered" alt="파스">
                            <p>상품설명</p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>마데카솔</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 826002");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/madecassol.jpg" class="img-responsive img-centered" alt="마데카솔">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>밴드</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 826003");
                            ...
                            ?>
                            <hr class="star-primary">
                            <img src="img/bandage.PNG" class="img-responsive img-centered" alt="밴드">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>타이레놀</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 826005");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/tylenol.jpg" class="img-responsive img-centered" alt="타이레놀">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>마스크</h2>
                            <?php
			       $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 826004");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/mask.jpg" class="img-responsive img-centered" alt="마스크">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
