            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="#product1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/sprite.jpg" class="img-responsive" alt="사이다">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/coke.jpg" class="img-responsive" alt="콜라">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/jelly.jpg" class="img-responsive" alt="젤리">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#product4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/ramen.jpg" class="img-responsive" alt="라면">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>사이다</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 695001");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/sprite.jpg" class="img-responsive img-centered" alt="사이다">
                            <p>상품설명</p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>콜라</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 695002");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/coke.jpg" class="img-responsive img-centered" alt="콜라">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>젤리</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 695003");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/jelly.jpg" class="img-responsive img-centered" alt="젤리">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>라면</h2>
                            <?php
                               $sql = oci_parse($conn, "select Product.Pprice, MAnufacturer.MAname, MAnufacturer.MAtp, MAnufacturer.MAadd from Product, MAnufacturer where Product.Pid = 695004");
                               oci_execute($sql);
                               $rows = oci_fetch_array($sql);
                               oci_free_statement($sql);
                            ?>
                            <hr class="star-primary">
                            <img src="img/ramen.jpg" class="img-responsive img-centered" alt="라면">
                            <p>상품설명</p>
                            <ul class="list-inline item-details">
                                <li>가격:
                                    <strong><?php echo $rows['PPRICE']; ?>원</a>
